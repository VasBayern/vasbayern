...
class HomeController extends Controller
{
    public function index() {
        ...
        $parent_1_categories = ShopCategoryModel::where('parent_id',0)->where('homepage',1)->offset(0)->limit(3)->get();
        $data['parent_1_categories'] = $parent_1_categories;
        $parent_2_categories = ShopCategoryModel::where('parent_id',0)->where('homepage',1)->offset(3)->limit(4)->get();
