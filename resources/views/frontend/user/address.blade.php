                ...
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1">
                    <div class="filter-widget">
                        ...
                        <ul class="filter-catagories">
                            ...
                            <li><a href="{{ url('user/address') }}" style="color: #e7ab3c">Địa chỉ giao hàng</a></li>
                    ...
                    <div class="modal-body">
                        <div class="col-lg-10 offset-lg-1">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-3"></div>
                                <div class="col-lg-8 ">
                                    <input type="checkbox" class="chkBox" id="chkBox" name="check" <?php if ($customer->default == 1) { echo 'checked';} ?>>
                                    <span style="margin-left: 10px;">Sử dụng địa chỉ này làm mặc định</span>
                                </div>
                            </div>
                        </div>
