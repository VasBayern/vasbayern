        ...
        <form action="" method="post" class="checkout-form">
            <div class="row">
                <form action="{{ url('payment') }}" method="post">
                                        ...
                                        <div class="detail-ship border">
                                            <div class="lol">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>{{ $cart_product->quantity }} x {{ $cart_product->name }}</li>
                                                    @endforeach
                                                </ul>
                                            </div>
                                            <div class="lol-price">
                        ...
                        <div class="place-order">
                            ...
                            if (isset($coupon)) {
                                if ($coupon['type'] == 'percent') {
                                    ...
                                    $discount_price = $sub_total * (float) $discount / 100;
                    ...
                    <div class="col-lg-4">
                        @if (isset($customer_default))
                        <input type="hidden" name="name" value="{{ isset($customer_default) ? $customer_default->name : $customer->name }}">
                        <input type="hidden" name="phone" value="{{ isset($customer_default) ? $customer_default->phone : $customer->phone }}">
                        ...
                        <input type="hidden" name="note" value="{{ isset($customer_default) ? $customer_default->note : $customer->note }}">
                        @elseif (!isset($customer_default) && isset($customer))
