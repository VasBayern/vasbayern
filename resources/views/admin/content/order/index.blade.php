                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Thành tiền</th>
                                    <th>Trạng thái</th>
                                    <th><a href="" id="orderProduct">View</a></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $stt = 1; ?>
                                ...
                                ?>
                                <td>
                                    <a href="#myModal" class="btn btn-success btn-action view-detail" data-toggle="modal" data-target="#modal-default" data-view="{{$order->id}}" title="Xem chi tiết"> <i class="fas fa-eye" style="width:15px"></i></a>
