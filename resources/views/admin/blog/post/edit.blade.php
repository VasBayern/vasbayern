    ...
    <form id="quickFormEdit">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mb-3">
                                <textarea class="textarea" name="intro_post" id="intro" placeholder="Place some text here" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                {{ $post->intro }}
                                </textarea>
                            </div>
                        </div>
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mb-3">
                                <textarea class="textareaPost" name="desc_post" id="desc" placeholder="Place some text here" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                {{ $post->desc}}
                                </textarea>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <input type="submit" value="Sửa" class="btn btn-success update-item" href="{{ url('api/admin/content/posts/'.$post->slug) }}">
            </div>
        </div>
    </form>
</section>
