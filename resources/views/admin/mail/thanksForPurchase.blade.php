            ...
            <tr>
                <td align="center" valign="middle" style="background:#ffffff">
                    <table style="width:580px" cellpadding="0" cellspacing="0" border="0">
                        <tbody>
                        <tr>
                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:20px;text-align:center;color:#ff3333;font-weight:bold;padding:30px 10px 0px 10px;">
                                Thư cảm ơn 
                            </td>
                        </tr>
                        <tr>
                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#666666;padding-left:10px;line-height:30px;">
                               <p>Cảm ơn quý khách đã mua hàng tại VASBAYERN SHOP.</p>
                               <p>Đơn hàng đã được giao tới quý khách.</p>
                               <p>Nếu sản phẩm không phù hợp với quý khách, có thể liên hệ với cửa hàng để được hỗ trợ ( với điều kiện phù hợp <a href="faq" style="color:#ff3333;text-decoration:underline">Chính sách đổi trả</a> của cửa hàng).</p>
                               <p>Mọi thắc mắc về sản phẩm, khuyến mại, ưu đãi với khách hàng thân thiết, quý khách có thể liên hệ với cửa hàng tại <a href="contact" style="color:#ff3333;text-decoration:underline">Đây</a></p>
                               <p>Một lần nữa xin cảm ơn quý khách đã tin tưởng shop. Chúc quý khách một ngày làm việc vui vẻ!!!</p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="padding-bottom:30px;border-bottom:1px solid #ebebeb">
                                <a href="{{ url('/') }}" style="font-family:Arial,Helvetica,sans-serif; color:#fff; padding: 10px 20px; font-size: 15px; margin-left: 230px; background: #FF3334; text-decoration:none;">Mua hàng</a>
                            </td>
                        </tr>
